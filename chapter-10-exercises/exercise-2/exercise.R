...
mean(salaries[!salaries$got_raise, ]$salary_adjustments)

## Consider: do the above averages match what you expected them to be based on 
## how you generated the salaries?

# Yes, because around 33% of people's salary decrease, ranging from $0 to $5000.
# The average should be around $2500, and considering the sample size,
# this number is not far from it.
